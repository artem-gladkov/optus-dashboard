...
const Char =(props)=>{
    ...
    useEffect(()=>{
        ...
        const chart = createChart(chartContainerRef.current, {
            layout: { textColor: 'black', background: { type: ColorType.Solid, color: 'rgba(255, 255, 255, 0.39)' } },
            rightPriceScale: {
                scaleMargins: {
                    top: 0.35,
                    bottom: 0.2,
        ...
        //     var price = param.seriesData.get(series);
    ...
    return ( 
        ...
        <div className=' h-400 w-full' ref={chartContainerRef}>
                <Comn char = {useChar} dateStr={dateStr} data={data}/>
        </div> 
    )
}

...
const SinglePairPageComponent = ({ typePage }: Props) => {
  ...
  const HandleChartsComponent = () => {
    if (toJS(getSinglePair.liquidity_graph)) {
      if (typeButtonCharts === "Liquidity") {
        return (
          <ChartsOverview
            ...
            titleMarker={false}
            type={"Liquidity"}
            data={toJS(getSinglePair.liquidity_graph)}
          />
        );
      }
      if (typeButtonCharts === "Volume") {
        return (
          <ChartsOverview
            ...
            titleMarker={false}
            type={"Volume (24hrs)"}
            data={toJS(getSinglePair.volume_graph)}
          />
        );
      }
      if (
      ...
      if (
        typeButtonCharts ===
        `${getSinglePair.token_two.symbol}-${getSinglePair.token_one.symbol}`
      ) {
  ...
  return (
    <>
      {getSinglePair.symbol_one_indicators ? (
        getErrorSinglePair ? (
          "Произошла ошибка, но мы уже решаем эту проблему"
        ) : (
            ...
            <div className="flex w-full h-full flex-col text-text xl:px-28  z-50 -mt-32">
              <div className="flex justify-between w-full  flex-wrap  items-center">
                <div className="flex">
                  ...
                  <span className="ml-6">
                    {getSinglePair.token_one.symbol}-
                    {getSinglePair.token_two.symbol}
                  </span>
                </div>
              </div>
              ...
              <div className="flex justify-between flex-col lg:flex-row mt-6">
                <div className="flex ld:text-3xl text-xl font-medium">
                  <div className="flex">
                    <div className="z-10">
                      <img
                        src={getSinglePair.token_one.image}
                        alt="iconToken"
                        width={30}
                        height={30}
                    ...
                    <div className="-ml-4">
                      <img
                        src={getSinglePair.token_two.image}
                        alt="iconToken"
                        width={30}
                        height={30}
                        className="rounded-full"
                  ...
                  <div className="ml-4">
                    {getSinglePair.token_one.symbol}-
                    {getSinglePair.token_two.symbol} <span>Pair</span>
                  </div>
                </div>
                ...
                <div>
                  <div className="flex flex-col lg:flex-row">
                    <div className="items-center bg-form rounded-lg px-3 py-1 hover:bg-opacity-40 mr-2 border border-inActive">
                      <Link
                        to={`https://tonapi.io/account/${getSinglePair.token_one.address}`}
                        target="_blank"
                      >
                        <button>
                    ...
                    <div className="items-center bg-form rounded-lg px-3 py-1 hover:bg-opacity-70 mr-2 border border-inActive">
                      <Link
                        to={`https://tonapi.io/account/${getSinglePair.token_two.address}`}
                        target="_blank"
                      >
                        <button>
              ...
              <div className="flex flex-col mt-10 ">
                ...
                <div className="md:flex md:justify-between w-full mt-3 ">
                  ...
                  <div className="md:flex flex-col w-4/12 mr-2  rounded-3xl justify-between hidden">
                    <TokenForm
                      title={"Liquidity"}
                      value={getSinglePair.liquidity.value}
                      change={getSinglePair.liquidity.change}
                    />
                    <TokenForm
                      title={"Volume (24hrs)"}
                      value={getSinglePair.volume_24h.value}
                      change={getSinglePair.volume_24h.change}
                    />
                    <TokenForm
                      title={"Fees (24hrs)"}
                      value={getSinglePair.fees_24h.value}
                      change={getSinglePair.fees_24h.change}
                    />
                    <div className="flex flex-col rounded-2xl p-4 mb-2 bg-form">
                      ...
                      <div className="flex">
                        ...
                        <div className="ml-2">
                          ...
                          <span>
                            {
                              getSinglePair.symbol_one_indicators.pool_quantity
                                .value
                            }
                          </span>{" "}
                          {getSinglePair.token_one.symbol}
                      ...
                      <div className="flex">
                        ...
                        <div className="ml-2">
                          ...
                          <span>
                            {
                              getSinglePair.symbol_two_indicators.pool_quantity
                                .value
                            }
                          </span>{" "}
                          {getSinglePair.token_two.symbol}
                  ...
                  <div className="bg-form flex flex-col md:w-8/12 rounded-2xl mb-2 text-text">
                    <div className="h-1/12 w-1/3 flex flex-col p-2 justify-between">
                      <button
                        className="md:hidden flex border items-center justify-around rounded-md"
                        onClick={() => setHandleButtonCharts((v) => !v)}
                      >
                        {" "}
                        {typeButtonCharts}
                      ...
                      <div className="hidden md:block">
                        <ButtonsCharts
                          namePairsOne={getSinglePair.token_one.symbol}
              ...
              <div className="flex flex-col mt-5">
                ...
                <PairInformation
                  pairname={`${getSinglePair.token_one.symbol} - ${getSinglePair.token_two.symbol}`}
              ...
              <div className="flex w-full h-10 m-10"></div>
            </div>
          </div>
        )
      ) : getErrorSinglePair ? (
